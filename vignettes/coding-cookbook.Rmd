...
Note that the computer will _always_ assume the data is independent of one another, that the errors are identically distributed, and that the mean model is correctly specified.
