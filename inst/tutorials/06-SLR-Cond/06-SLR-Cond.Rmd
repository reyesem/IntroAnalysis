...
```{r s6-ex-resid, exercise=TRUE, exercise.eval=FALSE, exercise.setup="s6-model"}
realestate.diag = obtain_diagnostics()
```

```{r s6-ex-resid-solution, exercise.setup="s6-model"}
...
```{r s6-ex-normality, exercise=TRUE, exercise.eval=FALSE, exercise.setup="s6-ex-resid-solution"}
ggplot() +
  aes() +
  labs()
```
...
```{r s6-ex-homoskedasticity, exercise=TRUE, exercise.eval=FALSE, exercise.setup="s6-ex-resid-solution"}
ggplot() +
  aes() +
  labs()
```
...
```{r s6-ex-indep, exercise=TRUE, exercise.eval=FALSE, exercise.setup="s6-ex-resid-solution"}
ggplot() +
  aes() +
  labs()
```
...
```{r s6-ex-mean0, exercise=TRUE, exercise.eval=FALSE, exercise.setup="s6-ex-resid-solution"}
ggplot() +
  aes() +
  labs()
```
